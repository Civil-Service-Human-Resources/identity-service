...
public class SpringUserUtilsTest {
    ...
    public void givenAValidIdentityUser_whenUpdateSpringAuthenticationAndSpringSessionWithUpdatedIdentity_thenShouldSpringAuthenticationAndSpringSessionShouldBeUpdatedWithTheNewValue() {
        ...
        // identity with uid of "reactivateduid" has recently reactivated flag set to true at the moment.
        assertThat(existingIdentity.isRecentlyReactivated()).isTrue();
        // update flag to be false
        existingIdentity.setRecentlyReactivated(false);
        ...
        // check that the identity that the spring authentication is using has recently reactivated flag set to false now.
        assertThat(actualIdentity.isRecentlyReactivated()).isFalse();
        ...
        assertThat(actualIdentityFromSpringSession.isRecentlyReactivated()).isFalse();
    }
