...
public class ListIdentitiesController {
    ...
    @GetMapping(value = "/api/identities", params = "domain")
    @ResponseBody
    public List<Identity> findAllByDomain(@RequestParam String domain) {
        return identityRepository.findByEmailEndsWith(domain);
    }
