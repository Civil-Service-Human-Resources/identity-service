...
public class RedirectController {
    ...
    @RequestMapping("/redirectToReactivationEnterTokenPage/{domain}/{uid}")
    public RedirectView goToEnterTokenSinceReactivationPage(Model model, RedirectAttributes redirectAttributes, @PathVariable String domain, @PathVariable String uid) {
        /*
         * This redirect is required in order to pass the domain and uid to the enter token page,
         * so that the associated agency token validation is possible.
         */
        ...
        redirectAttributes.addFlashAttribute("uid", uid);
        RedirectView redirectView = new RedirectView();
        redirectView.setUrl("/reactivate/enterToken");
        return redirectView;
    }
